...
public class XmlTag : MatchedSubstring
{
    ...
    public ImmutableDictionary<string, XmlAttribute> Attributes => _attributes ??= XmlAttribute.Parse(this[nameof(Attributes)]).ToImmutableDictionary(attr => attr.Name.Text);
